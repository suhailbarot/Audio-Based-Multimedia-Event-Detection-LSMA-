...
video_path=../../11775_videos/video   # path to the directory containing all the videos. In this example setup, we are linking all the videos to "../video"
cluster_num=450        # the number of clusters in k-means. Note that 50 is by no means the optimal solution.
...
# cat "list/train.video" "list/val.video" > "./merged_video"
# python scripts/select_frames.py "merged_video" 0.2 select.mfcc.csv || exit 1;
